...
export class SpriteRenderService implements RenderItemInterface<Sprite> {
  ...
  public init(renderState: RenderState) {
    ...
    this.vertexPosition = gl.getAttribLocation(
      this.shaderProgram,
      "aVertexPosition"
    );
    this.vertexColour = gl.getAttribLocation(this.shaderProgram, "colour");
    this.vertexTranslation = gl.getAttribLocation(
      this.shaderProgram,
      "aVertexTranslation"
    );
    this.texturePosition = gl.getAttribLocation(
      this.shaderProgram,
      "aTextureCoord"
    );
    ...
    this.modelMatrix = gl.getUniformLocation(
      this.shaderProgram,
      "uModelViewMatrix"
    );
